...
1. **Brief** — Threat propagation chain and severity briefing. Domain scores initialise.
2. **Intel** — Spend up to 3 intelligence tokens to reveal hidden observables before deciding.
3. **Decision** — Choose from 4 governance response options, each with explicit trade-off tags.
4. **After-Action Review** — Full governance score breakdown, decision history, and legacy score.

---

## Governance Domains Covered

- Supply chain integrity (SBOM, vendor concentration, grey-market hardware)
