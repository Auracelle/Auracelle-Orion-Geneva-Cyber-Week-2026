# Changelog — Auracelle Orion · Geneva Cyber Week 2026 Edition
...
- **DOE / National Lab colour palette** — institutional design register appropriate for GCW audience
...
### Added
- Initial Geneva Cyber Week 2026 HTML prototype (`index.html`)
